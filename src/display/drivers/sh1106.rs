...
impl Sh1106Driver {
    ...
    /// Returns default DisplayConfig for SH1106 over SPI
    ...
    fn make_capabilities(width: u32, height: u32) -> DisplayCapabilities {
        DisplayCapabilities {
            ...
            // SH1106 supports both I2C and SPI, selected by hardware strapping
    ...
    /// Create a new SH1106 driver using SPI (4-wire)
    ///
    /// # Arguments
    ...
    pub fn new_spi(
        ...
        info!("Initializing SH1106 SPI on {} DC={} RST={:?}",
        ...
        // TODO: open SPI bus, configure DC/RST GPIO pins, pulse reset, and send
        //       the SH1106 init sequence (see new_i2c comments above), then use
        //       page-addressed writes for flush.
