...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    oled_display.splash(show_splash).unwrap();
                ...
                if lms_guard.is_playing() {
                    ...
                    if lms_guard.has_changed() {
                        ...
                        oled_display.set_status_line_data(
                            ...
                            current_is_muted,
                            lms_guard.tags[TagID::SAMPLESIZE as usize].value.clone(),
                            lms_guard.tags[TagID::SAMPLERATE as usize].value.clone(),
                            current_repeat,
                            current_shuffle,
                        );
                        ...
                        oled_display.set_track_details(
                            lms_guard.tags[TagID::ALBUMARTIST as usize].value.clone(), 
                            lms_guard.tags[TagID::ALBUM as usize].value.clone(), 
                            lms_guard.tags[TagID::TITLE as usize].value.clone(), 
                            lms_guard.tags[TagID::ARTIST as usize].value.clone(), 
                        );
                        ...
                        oled_display.set_track_progress_data(
                            ...
                            lms_guard.tags[TagID::MODE as usize].value.clone(),
                        );
